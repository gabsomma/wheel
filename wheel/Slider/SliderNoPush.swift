...
//  wheel
//
//  Created by Gabriel Somma on 2023-05-15.
//

import Foundation
import SwiftUI

struct SliderNoPush: View {
    ...
    func ScheduleSlider() -> some View {
        GeometryReader { proxy in
            ...
            ZStack {
                ...
                Circle()
                    .trim(from: min(startProgress, toProgress), to: max(startProgress, toProgress))
//                    .trim(from: 0.9, to: 0.3)
...
struct SliderNoPush_Previews: PreviewProvider {
